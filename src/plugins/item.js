      ...
      if(seckill){
        // var now = new Date().getTime()/1000;
          ...
          if(now < seckill.start_time){
            //尚未开始
            $('.J_seckill_time').html('距秒杀开始<br/><span class="text-danger day">00</span>天<span class="text-danger hour">00</span>小时<span class="text-danger minute">00</span>分钟<span class="text-danger second">00</span>秒');
            ...
            //进行中
            $('.J_seckill_time').html('距秒杀结束<br/><span class="text-danger day">00</span>天<span class="text-danger hour">00</span>小时<span class="text-danger minute">00</span>分钟<span class="text-danger second">00</span>秒');
